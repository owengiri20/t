...
export default function LeaderboardTablePerUser({ limit }: { limit?: number }) {
    ...
    const { refetch } = useQuery({
        ...
        queryFn: async ({ queryKey }) => {
            ...
            const res = await fetchData(`/leaderboard/highest-wpm-per-user?${params.toString()}`, "GET", null)
    ...
    return (
        <TableContainer component={Box} style={{ height: "100%", display: "flex", flexDirection: "column", overflowY: "auto" }}>
